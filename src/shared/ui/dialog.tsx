...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-2 p-6 pt-2 md:flex-row-reverse md:justify-between",
        className
      )}
      {...props}
    >
